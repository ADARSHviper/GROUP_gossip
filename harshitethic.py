...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "Done! Congratulations on your new bot. You will find it at t.me/SMART_KINKY_bot. You can now add a description, about section and profile picture for your bot, see /help for a list of commands. By the way, when you've finished creating your cool bot, ping our Bot Support if you want a better username for it. Just make sure the bot is fully operational before you do this.

Use this token to access the HTTP API:
6144655376:AAH1PC2Yt-qQM4iar075dI-p3EfxvTaF-cM
